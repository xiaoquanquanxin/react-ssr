...
const Production = AsyncRouter(
  () => import("@shared/components/production/production")
);
const ProductionDetail = AsyncRouter(
  () =>
    import("@shared/components/production/productionDetail/productionDetail")
);
...
const routesForSsr: RouteConfig = [];
