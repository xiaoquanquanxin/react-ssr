const getCdnScripts = (mode) => {
  switch (mode) {
    case "development":
      return `<script src="https://cdn.bootcdn.net/ajax/libs/react/17.0.2/umd/react.development.min.js"></script>
    ...
    case "production":
      return `<script src="https://cdn.bootcdn.net/ajax/libs/react/17.0.2/umd/react.production.min.js"></script>
